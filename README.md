# Belize Bird Community Composition - MoSI

The purpose of this repository is to store the R code for running the analyses and figures for the Belize bird community composition paper using MoSI banding data.
